...
INSERT IGNORE INTO bannerdata VALUES ('FISH','<image src="/images/banner_fish.gif">');
INSERT IGNORE INTO bannerdata VALUES ('CATS','<image src="/images/banner_cats.gif">');
INSERT IGNORE INTO bannerdata VALUES ('DOGS','<image src="/images/banner_dogs.gif">');
INSERT IGNORE INTO bannerdata VALUES ('REPTILES','<image src="/images/banner_reptiles.gif">');
INSERT IGNORE INTO bannerdata VALUES ('BIRDS','<image src="/images/banner_birds.gif">');

INSERT IGNORE INTO category VALUES ('FISH','Fish','<image src="/images/fish_icon.gif"><font size="5" color="blue"> Fish</font>');
INSERT IGNORE INTO category VALUES ('DOGS','Dogs','<image src="/images/dogs_icon.gif"><font size="5" color="blue"> Dogs</font>');
INSERT IGNORE INTO category VALUES ('REPTILES','Reptiles','<image src="/images/reptiles_icon.gif"><font size="5" color="blue"> Reptiles</font>');
INSERT IGNORE INTO category VALUES ('CATS','Cats','<image src="/images/cats_icon.gif"><font size="5" color="blue"> Cats</font>');
INSERT IGNORE INTO category VALUES ('BIRDS','Birds','<image src="/images/birds_icon.gif"><font size="5" color="blue"> Birds</font>');

INSERT IGNORE INTO product VALUES ('FI-SW-01','FISH','Angelfish','<image src="/images/fish1.gif">Salt Water fish from Australia');
INSERT IGNORE INTO product VALUES ('FI-SW-02','FISH','Tiger Shark','<image src="/images/fish4.gif">Salt Water fish from Australia');
INSERT IGNORE INTO product VALUES ('FI-FW-01','FISH', 'Koi','<image src="/images/fish3.gif">Fresh Water fish from Japan');
INSERT IGNORE INTO product VALUES ('FI-FW-02','FISH', 'Goldfish','<image src="/images/fish2.gif">Fresh Water fish from China');
INSERT IGNORE INTO product VALUES ('K9-BD-01','DOGS','Bulldog','<image src="/images/dog2.gif">Friendly dog from England');
INSERT IGNORE INTO product VALUES ('K9-PO-02','DOGS','Poodle','<image src="/images/dog6.gif">Cute dog from France');
INSERT IGNORE INTO product VALUES ('K9-DL-01','DOGS', 'Dalmation','<image src="/images/dog5.gif">Great dog for a Fire Station');
INSERT IGNORE INTO product VALUES ('K9-RT-01','DOGS', 'Golden Retriever','<image src="/images/dog1.gif">Great family dog');
INSERT IGNORE INTO product VALUES ('K9-RT-02','DOGS', 'Labrador Retriever','<image src="/images/dog5.gif">Great hunting dog');
INSERT IGNORE INTO product VALUES ('K9-CW-01','DOGS', 'Chihuahua','<image src="/images/dog4.gif">Great companion dog');
INSERT IGNORE INTO product VALUES ('RP-SN-01','REPTILES','Rattlesnake','<image src="/images/snake1.gif">Doubles as a watch dog');
INSERT IGNORE INTO product VALUES ('RP-LI-02','REPTILES','Iguana','<image src="/images/lizard1.gif">Friendly green friend');
INSERT IGNORE INTO product VALUES ('FL-DSH-01','CATS','Manx','<image src="/images/cat2.gif">Great for reducing mouse populations');
INSERT IGNORE INTO product VALUES ('FL-DLH-02','CATS','Persian','<image src="/images/cat1.gif">Friendly house cat, doubles as a princess');
INSERT IGNORE INTO product VALUES ('AV-CB-01','BIRDS','Amazon Parrot','<image src="/images/bird2.gif">Great companion for up to 75 years');
INSERT IGNORE INTO product VALUES ('AV-SB-02','BIRDS','Finch','<image src="/images/bird1.gif">Great stress reliever');
