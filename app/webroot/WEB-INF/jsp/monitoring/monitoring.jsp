...
<link rel="stylesheet" href="<aspectran:url value="/assets/css/monitoring.css?20240307"/>"/>
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.30.1/moment-with-locales.min.js"></script>
<script src="<aspectran:url value="/assets/js/monitoring-log.js?20240307"/>"></script>
<script src="<aspectran:url value="/assets/js/monitoring-session.js?20240307"/>"></script>
